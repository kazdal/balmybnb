  ...
  render() {
    return (
      <form onSubmit={this.handleSubmit} className="review-form">
        ...
        <label>
          <p>
            Describe Your Experience <span>(required)</span>
          </p>
          <textarea
