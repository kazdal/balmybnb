...
#   Character.create(name: 'Luke', movie: movies.first)
  ...
  Spot.create(title: 'Luxury Beach Apartment', description: 'Enjoy & Maximise your stay in the heart of the Gold Coast with a private room in a modern renovated unit. Located right between Surfers and Broadbeach, short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Booking.create(start_date: '01-04-2018', end_date: '11-04-2018', user_id: User.first.id, spot_id: Spot.find(12).id)
    Booking.create(start_date: '15-04-2018', end_date: '19-04-2018', user_id: User.first.id, spot_id: Spot.find(12).id)
    Booking.create(start_date: '23-04-2018', end_date: '28-04-2018', user_id: User.first.id, spot_id: Spot.find(12).id)
    Booking.create(start_date: '03-05-2018', end_date: '12-05-2018', user_id: User.first.id, spot_id: Spot.find(12).id)
    Booking.create(start_date: '12-05-2018', end_date: '23-05-2018', user_id: User.first.id, spot_id: Spot.find(12).id)
    Booking.create(start_date: '24-05-2018', end_date: '28-05-2018', user_id: User.first.id, spot_id: Spot.find(12).id)
  ...
  Spot.create(title: 'South Beach Apartment', description: 'Enjoy & Maximise your stay in the heart of the beach area with a private room in a modern renovated unit. Located right between the most popular two beaches, a short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Booking.create(start_date: '14-04-2018', end_date: '19-04-2018', user_id: User.first.id, spot_id: Spot.find(14).id)
  ...
  Spot.create(title: 'Downtown Miami', description: 'Enjoy & Maximise your stay in the heart of the beach area with a private room in a modern renovated unit. Located right between the most popular two beaches, a short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Review.create(title: 'What a great place', body: 'Everything was perfect! We had a nice bedroom, delicious breakfast every morning and the house has a very nice pool area. It is close to everything.', rating: 3, spot_id: Spot.find(18).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'Wonderfully great spot. Nice place with a great view and proximity to great attractions.', rating: 4, spot_id: Spot.find(18).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'What a great host and we all felt like we were at home when we walked through the door. Sooo close to surfers. It was awesome. Thanks again.', rating: 3, spot_id: Spot.find(18).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'Such a nice place. Nicer than I expected. So very nice.', rating: 4, spot_id: Spot.find(18).id, user_id: User.first.id)  
  ...
  Spot.create(title: 'Honolulu House with a view', description: 'Enjoy & Maximise your stay in the heart of the beach area with a private room in a modern renovated unit. Located right between the most popular two beaches, a short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Review.create(title: 'What a great place', body: 'Everything was perfect! We had a nice bedroom, delicious breakfast every morning and the house has a very nice pool area. It is close to everything.', rating: 5, spot_id: Spot.find(20).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'Wonderfully great spot. Nice place with a great view and proximity to great attractions.', rating: 5, spot_id: Spot.find(20).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'What a great host and we all felt like we were at home when we walked through the door. Sooo close to surfers. It was awesome. Thanks again.', rating: 3, spot_id: Spot.find(20).id, user_id: User.first.id)
  ...
  Spot.create(title: 'Spacious House near Diamond Head', description: 'Enjoy & Maximise your stay in the heart of the beach area with a private room in a modern renovated unit. Located right between the most popular two beaches, a short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Review.create(title: 'What a great place', body: 'Everything was perfect! We had a nice bedroom, delicious breakfast every morning and the house has a very nice pool area. It is close to everything.', rating: 4, spot_id: Spot.find(21).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'Wonderfully great spot. Nice place with a great view and proximity to great attractions.', rating: 4, spot_id: Spot.find(21).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'What a great host and we all felt like we were at home when we walked through the door. Sooo close to surfers. It was awesome. Thanks again.', rating: 3, spot_id: Spot.find(21).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'Such a nice place. Nicer than I expected. So very nice.', rating: 3, spot_id: Spot.find(21).id, user_id: User.first.id) 
  ...
  Spot.create(title: 'Large House near Hanauma', description: 'Enjoy & Maximise your stay in the heart of the beach area with a private room in a modern renovated unit. Located right between the most popular two beaches, a short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Booking.create(start_date: '22-04-2018', end_date: '28-04-2018', user_id: User.first.id, spot_id: Spot.find(22).id)
    Booking.create(start_date: '03-05-2018', end_date: '12-05-2018', user_id: User.first.id, spot_id: Spot.find(22).id)
    Booking.create(start_date: '13-05-2018', end_date: '22-05-2018', user_id: User.first.id, spot_id: Spot.find(22).id)
  ...
  Spot.create(title: 'Waimanalo Beach Apartment', description: 'Enjoy & Maximise your stay in the heart of the beach area with a private room in a modern renovated unit. Located right between the most popular two beaches, a short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Review.create(title: 'What a great place', body: 'Everything was perfect! We had a nice bedroom, delicious breakfast every morning and the house has a very nice pool area. It is close to everything.', rating: 4, spot_id: Spot.find(23).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'Wonderfully great spot. Nice place with a great view and proximity to great attractions.', rating: 5, spot_id: Spot.find(23).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'What a great host and we all felt like we were at home when we walked through the door. Sooo close to surfers. It was awesome. Thanks again.', rating: 4, spot_id: Spot.find(23).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'Such a nice place. Nicer than I expected. So very nice.', rating: 4, spot_id: Spot.find(23).id, user_id: User.first.id) 
  ...
  Spot.create(title: 'Clean & Large Apartment', description: 'Enjoy & Maximise your stay in the heart of the beach area with a private room in a modern renovated unit. Located right between the most popular two beaches, a short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Review.create(title: 'What a great place', body: 'Everything was perfect! We had a nice bedroom, delicious breakfast every morning and the house has a very nice pool area. It is close to everything.', rating: 4, spot_id: Spot.find(26).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'Wonderfully great spot. Nice place with a great view and proximity to great attractions.', rating: 4, spot_id: Spot.find(26).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'What a great host and we all felt like we were at home when we walked through the door. Sooo close to surfers. It was awesome. Thanks again.', rating: 5, spot_id: Spot.find(26).id, user_id: User.first.id)
  ...
  Spot.create(title: 'Apartment close to the Beach', description: 'Enjoy & Maximise your stay in the heart of the beach area with a private room in a modern renovated unit. Located right between the most popular two beaches, a short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Review.create(title: 'What a great place', body: 'Everything was perfect! We had a nice bedroom, delicious breakfast every morning and the house has a very nice pool area. It is close to everything.', rating: 3, spot_id: Spot.find(27).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'Wonderfully great spot. Nice place with a great view and proximity to great attractions.', rating: 4, spot_id: Spot.find(27).id, user_id: User.first.id)
    Review.create(title: 'What a great place', body: 'What a great host and we all felt like we were at home when we walked through the door. Sooo close to surfers. It was awesome. Thanks again.', rating: 4, spot_id: Spot.find(27).id, user_id: User.first.id)
  ...
  Spot.create(title: 'Beachside Villa', description: 'Enjoy & Maximise your stay in the heart of the beach area with a private room in a modern renovated unit. Located right between the most popular two beaches, a short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Review.create(title: 'What a great place', body: 'Everything was perfect! We had a nice bedroom, delicious breakfast every morning and the house has a very nice pool area. It is close to everything.', rating: 4, spot_id: Spot.find(28).id, user_id: User.first.id)
    ...
    Review.create(title: 'What a great place', body: 'What a great host and we all felt like we were at home when we walked through the door. Sooo close to surfers. It was awesome. Thanks again.', rating: 4, spot_id: Spot.find(28).id, user_id: User.first.id)
  ...
  Spot.create(title: 'Geger Beach Apartment', description: 'Enjoy & Maximise your stay in the heart of the beach area with a private room in a modern renovated unit. Located right between the most popular two beaches, a short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Review.create(title: 'What a great place', body: 'Everything was perfect! We had a nice bedroom, delicious breakfast every morning and the house has a very nice pool area. It is close to everything.', rating: 3, spot_id: Spot.find(29).id, user_id: User.first.id)
    ...
    Review.create(title: 'What a great place', body: 'What a great host and we all felt like we were at home when we walked through the door. Sooo close to surfers. It was awesome. Thanks again.', rating: 3, spot_id: Spot.find(29).id, user_id: User.first.id)
  ...
  Spot.create(title: 'Room near Nusa Dua', description: 'Enjoy & Maximise your stay in the heart of the beach area with a private room in a modern renovated unit. Located right between the most popular two beaches, a short walk to the beach, public transport, restaurants, nightlife and attractions!', 
    ...
    Review.create(title: 'What a great place', body: 'Everything was perfect! We had a nice bedroom, delicious breakfast every morning and the house has a very nice pool area. It is close to everything.', rating: 4, spot_id: Spot.find(30).id, user_id: User.first.id)
    ...
    Review.create(title: 'What a great place', body: 'What a great host and we all felt like we were at home when we walked through the door. Sooo close to surfers. It was awesome. Thanks again.', rating: 4, spot_id: Spot.find(30).id, user_id: User.first.id)
